# Load a bar with the plate calculator

Open **Plates** from the app's quick actions. Pick the bar and gym, then choose
the physical plate type:

- **Bumper** keeps competition discs at their Olympic diameter and shows the
  thicker rubber stack used on an Olympic platform.
- **Steel** shows the thinner, denomination-stepped geometry of calibrated
  strength plates.
