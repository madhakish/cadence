...
// (all presses, all squat/hinge variants, the oly lifts). Groups: squat,
...
const exercises = [
  ...
  ex("Good Morning", "Accessory", "barbell", "hinge", { defaultRestSeconds: 120, watchSite: "Left hip" }),
  // --- Accessories ---
  ...
  ex("Band External Rotation", "Accessory", "band", "shoulder", { isUnilateral: true, defaultRestSeconds: 60, watchSite: "Left shoulder" }),
  ex("DB Curls", "Accessory", "dumbbell", "arms"),
  ex("DB Overhead Triceps Extension", "Accessory", "dumbbell", "arms"),
  ex("Walking Lunges", "Accessory", "bodyweight", "squat", { isUnilateral: true, watchSite: "Left hip" }),
