    ...
    days: [
      { name: "Day A",
        lifts: [lift("Back Squat", "main", 95, 150, { prescription: "linearFives", sets: 3, startFraction: 0.74 }),
                lift("Overhead Press", "main", 65, 95, { prescription: "linearFives", sets: 3, startFraction: 0.74 }),
                lift("Deadlift", "main", 135, 205, { prescription: "linearFives", sets: 1, startFraction: 0.74 })],
        accessories: [] },
      { name: "Day B",
        lifts: [lift("Back Squat", "main", 95, 150, { prescription: "linearFives", sets: 3, startFraction: 0.74 }),
                lift("Barbell Bench", "main", 85, 125, { prescription: "linearFives", sets: 3, startFraction: 0.74 }),
                lift("Deadlift", "main", 135, 205, { prescription: "linearFives", sets: 1, startFraction: 0.74 })],
    ...
    days: [
      { name: "Day A",
        lifts: [lift("Back Squat", "main", 95, 150, { prescription: "linearFives", sets: 5, startFraction: 0.74 }),
                lift("Barbell Bench", "main", 85, 125, { prescription: "linearFives", sets: 5, startFraction: 0.74 }),
                lift("Barbell Row", "main", 95, 135, { prescription: "linearFives", sets: 5, startFraction: 0.74 })],
        accessories: [] },
      { name: "Day B",
        lifts: [lift("Back Squat", "main", 95, 150, { prescription: "linearFives", sets: 5, startFraction: 0.74 }),
                lift("Overhead Press", "main", 65, 95, { prescription: "linearFives", sets: 5, startFraction: 0.74 }),
                lift("Deadlift", "main", 135, 205, { prescription: "linearFives", sets: 1, startFraction: 0.74 })],
        accessories: [acc("Chin-ups", 3, 5, 10)] },
    ],
  },
  // Texas Method week as six slots over a two-week A/B pass so the presses
  // alternate weekly. Each slot owns its base at the published ratio of the
  // lift's 5RM (volume 90%, light 80% of volume, intensity = the 5RM PR set);
  // lower slots take +10 per completion so each lift lands on +5 lb/week.
  {
    id: "texas-method",
    name: "Texas Method",
    ...
    days: [
      { name: "Volume A",
        lifts: [lift("Back Squat", "main", 135, 205, { prescription: "texasVolume", sets: 5, startFraction: 0.77 }),
                lift("Barbell Bench", "main", 85, 125, { prescription: "texasVolume", sets: 5, startFraction: 0.77 })],
      ...
      { name: "Light A",
        lifts: [lift("Back Squat", "main", 110, 205, { prescription: "texasLight", sets: 2, startFraction: 0.62 }),
                lift("Overhead Press", "main", 55, 95, { prescription: "texasLight", sets: 3, startFraction: 0.69 })],
        accessories: [acc("Chin-ups", 3, 5, 10)] },
      { name: "Intensity A",
        lifts: [lift("Back Squat", "main", 150, 205, { prescription: "texasIntensity", sets: 1, startFraction: 0.86 }),
                lift("Barbell Bench", "main", 95, 125, { prescription: "texasIntensity", sets: 1, startFraction: 0.86 }),
                lift("Deadlift", "main", 185, 245, { prescription: "texasIntensity", sets: 1, startFraction: 0.86 })],
        accessories: [] },
      { name: "Volume B",
        lifts: [lift("Back Squat", "main", 135, 205, { prescription: "texasVolume", sets: 5, startFraction: 0.77 }),
                lift("Overhead Press", "main", 65, 95, { prescription: "texasVolume", sets: 5, startFraction: 0.77 })],
        accessories: [acc("Back Extension", 3, 10, 15)] },
      { name: "Light B",
        lifts: [lift("Back Squat", "main", 110, 205, { prescription: "texasLight", sets: 2, startFraction: 0.62 }),
                lift("Barbell Bench", "main", 75, 125, { prescription: "texasLight", sets: 3, startFraction: 0.69 })],
        accessories: [acc("Chin-ups", 3, 5, 10)] },
      { name: "Intensity B",
        lifts: [lift("Back Squat", "main", 150, 205, { prescription: "texasIntensity", sets: 1, startFraction: 0.86 }),
                lift("Overhead Press", "main", 80, 95, { prescription: "texasIntensity", sets: 1, startFraction: 0.86 }),
                lift("Deadlift", "main", 185, 245, { prescription: "texasIntensity", sets: 1, startFraction: 0.86 })],
        accessories: [] },
    ],
  },
    ...
    days: [
      ...
      { name: "Dynamic Effort Lower",
        lifts: [lift("Back Squat", "main", 95, 205, { prescription: "dynamicEffort", startFraction: 0.50 }),
                lift("Deadlift", "main", 145, 245, { prescription: "dynamicEffort", startFraction: 0.60 })],
