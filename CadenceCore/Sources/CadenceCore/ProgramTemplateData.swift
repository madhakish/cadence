...
public enum ProgramTemplateData {
    ...
    public static let all: [Template] = [
        ...
        Template(
            ...
            days: [
                TemplateDay("Snatch + Front Squat",
                            lifts: [TemplateLift("Snatch", "main", 65, 115,
                                                 prescription: "technique"),
                                    TemplateLift("Front Squat", "complementary", 115, 185,
                                                 prescription: "technique")],
                            accessories: [TemplateAccessory("Snatch Pull", 3, 3, 3, weightLb: 95, incrementLb: 10),
                                          TemplateAccessory("Hanging Knee Raise", 3, 8, 15)]),
                TemplateDay("Jerk + Overhead",
                            lifts: [TemplateLift("Split Jerk", "main", 65, 105,
                                                 prescription: "technique", historyExercise: "Clean & Jerk"),
                                    TemplateLift("Push Press", "complementary", 65, 105,
                                                 prescription: "linearFives", sets: 3),
                                    TemplateLift("Overhead Squat", "complementary", 65, 115,
                                                 prescription: "technique", historyExercise: "Snatch")],
                            accessories: [TemplateAccessory("Pull-ups", 3, 5, 10),
                                          TemplateAccessory("Hanging Knee Raise", 3, 8, 15)]),
                TemplateDay("Clean & Jerk + Back Squat",
                            lifts: [TemplateLift("Clean & Jerk", "main", 85, 145,
                                                 prescription: "technique"),
                                    TemplateLift("Back Squat", "complementary", 135, 225,
                                                 prescription: "linearFives", sets: 3)],
                            accessories: [TemplateAccessory("Clean Pull", 3, 3, 3, weightLb: 115, incrementLb: 10),
                                          TemplateAccessory("Hanging Knee Raise", 3, 8, 15)]),
            ]
        ),
        Template(
