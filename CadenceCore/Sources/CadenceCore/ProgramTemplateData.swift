            ...
            days: [
                TemplateDay("Upper A",
                            ...
                            accessories: [TemplateAccessory("Chin-ups", 3, 5, 10),
                                          TemplateAccessory("Single-arm DB Row", 3, 8, 12, weightLb: 40, incrementLb: 5)]),
                TemplateDay("Lower A",
                ...
                TemplateDay("Upper B",
                            lifts: [TemplateLift("Push Press", "main", 75, 115),
                                    TemplateLift("Incline DB Press", "complementary", 50, 80)],
                            accessories: [TemplateAccessory("Push-ups", 3, 10, 25),
                                          TemplateAccessory("Single-arm DB Row", 3, 8, 12, weightLb: 40, incrementLb: 5)]),
                TemplateDay("Lower B",
