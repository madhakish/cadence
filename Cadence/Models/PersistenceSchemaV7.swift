...
/// Frozen schema shipped as V7 — the version that promoted vertical pulling to
/// a main lift. V7 is where `AppSettings.verticalPullMainsPromoted` arrived,
/// the one-shot stamp for the seeded pull-up category repair.
///
/// These declarations exactly preserve V7's checksum and **must never be
/// edited**. Freezing it here is what makes the V8 migration provable, the same
/// way freezing V6 made V7's provable. V7 is V6 plus
/// `AppSettings.verticalPullMainsPromoted` and nothing else — every other model
/// is byte-identical to the V6 snapshot.
