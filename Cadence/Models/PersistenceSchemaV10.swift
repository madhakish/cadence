...
/// Frozen schema shipped as V10. V10 is the V9 model plus
/// `SessionExercise.barIDIsManual` (literal `false` default) and the new
/// `TrainingInterval` model, and nothing else. These declarations preserve
/// that checksum and must never be edited.
enum CadenceSchemaV10: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [
            ...
            // frozen shape (same convention as Gym/AppSettings above).
