...
/// Frozen schema shipped as V13 (optional TFH configuration and evidence).
/// Do not edit this historical model shape.
enum CadenceSchemaV13: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [
            ...
            TrainingInterval.self, ActivityDetail.self,
        ]
    }
    ...
    final class ActivityDetail {
        ...
        var session: WorkoutSession?
        init(kindRaw: String) { self.kindRaw = kindRaw }
    }
}
