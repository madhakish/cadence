...
enum ProgramTemplates {
    ...
    @discardableResult
    static func instantiate(_ template: ProgramTemplateData.Template, context: ModelContext) -> Program {
        ...
        // the user's records — skipping creation only degrades new sessions
        // (no warmup ramp/type info) until the library is readable again.
