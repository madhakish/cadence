...
final class PersistenceMigrationTests: XCTestCase {
    ...
    private func createV6Store(at url: URL) throws {
        ...
        // The lifter already promoted this one before the migration shipped.
        // V7 may promote the untouched Pull-ups row, but must not treat every
        // named vertical pull as seed-owned state.
        let chinUps = CadenceSchemaV6.Exercise(
            name: "Chin-ups", categoryRaw: "Main", typeRaw: "bodyweight")
