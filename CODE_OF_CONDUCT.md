...
Cadence is a training log. Issues and discussions will sometimes touch on
bodyweight, injury, rehabilitation, eating, and training under medical
supervision. Treat that material as someone's health information, not as
material for judgment or advice.

Concretely:

* Do not comment on anyone's bodyweight, physique, or numbers except where they
  have explicitly asked for that feedback.
* Do not give medical, rehabilitation, or nutrition advice in issues. If a bug
  report involves an injury, address the software.
* Do not paste another person's exported data, screenshots of their log, or
  their body metrics into an issue.
...
This Code of Conduct applies within all project spaces — the issue tracker, pull
...
[GitHub's private vulnerability reporting](https://github.com/madhakish/cadence/security/advisories/new)
for anything sensitive, or by contacting
[@madhakish](https://github.com/madhakish) directly. Serious abuse can also be
escalated to GitHub via [Report abuse](https://github.com/contact/report-abuse).
